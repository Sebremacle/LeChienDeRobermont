...
@section('contenu')
        ...
        <div id="pages" class="trans" style="width: 9096px; right: 0%; height: 2188px;">
            ...
            <section id="section2" class="page-systeme page-contenu" style="width: 1516px; min-height: 796px;">
                ...
                <article>
                    <h2 class="text-center transform titreArticle">Notre méthode de travail</h2>
                    <div class="article row lato  ">
                        <div class="text-center transform thumb"></div>
                        <div>
                            <p><span lang="\&quot;FR\&quot;">Nous travaillons d’une manière positive, c’est-à-dire en privilégiant les récompenses plutôt que les sanctions. </span><span lang="\&quot;FR\&quot;">Mais tout mauvais comportement tel que&nbsp;: agressivité, aboiements intempestifs… sera fermement réprimandé.</span></p>
                ...
                <article>
                    <h2 class="text-center transform titreArticle">Nos installations</h2>
                    <div class="article row lato  ">
                        <div class="text-center transform thumb">
                            <img width="960" height="720" src="{{ URL::asset('img/11.jpg') }}" class="attachment-post-thumbnail wp-post-image" alt="1">
                        </div>
                        <div>
                            <ul>
                                <li>Accès facile</li>
                ...
                <article>
                    <h2 class="text-center transform titreArticle">Le comité</h2>
                    <div class="article row lato  ">
                        <div class="text-center transform thumb"></div>
                        <div>
                ...
                <article>
                    <h2 class="text-center transform titreArticle">L’historique de notre club</h2>
                    <div class="article row lato  ">
                        <div class="text-center transform thumb"></div>
                        <div>
                            <p><span lang="\&quot;\\&quot;\\\\&quot;\\\\\\\\&quot;\\\\\\\\\\\\\\\\&quot;\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\&quot;FR\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\&quot;\\\\\\\\\\\\\\\\&quot;\\\\\\\\&quot;\\\\&quot;\\&quot;\&quot;">Le club a été fondé le 5 octobre 1922. Il est directement affilié à l’Union Royale Cynologique de la Saint-Hubert (URCSH), sous le matricule 0080 et appelé «&nbsp;Le Chien de Défense de Robermont&nbsp;»</span></p>
            ...
            <section id="section3" class="page-systeme page-contenu" style="width: 1516px; min-height: 796px;">
                ...
                <article>
                    ...
                    <article>
                        <h2 class="text-center transform titreArticle ">Déroulement des cours</h2>
                        <div class="article row lato  ">
                            <div class="text-center transform thumb"></div>
                            <div>
                                <p><span lang="\&quot;\\&quot;FR\\&quot;\&quot;">Les cours ont lieu 2 fois par semaine&nbsp;: mercredi soir et dimanche matin.</span></p>
            ...
            <section id="section4" class="page-systeme page-contenu" style="width: 1516px; min-height: 796px;">
                ...
                <article>
                    <h2 class="text-center transform titreArticle">16/05 : Evenement n°1</h2>
                    <div class="article row lato  ">
                        <div class="text-center transform thumb"></div>
                        <div>
                            <p>Cras tortor lorem, imperdiet eget justo sed, tristique dictum lectus. Nullam ligula ex, blandit quis luctus nec, porta eu sem. Etiam rhoncus accumsan tellus. Phasellus tempor ante ac sapien suscipit faucibus.</p>
                        </div>
                    </div>
                </article>    
            </section> 
            <section id="section5" class="page-systeme page-contenu" style="width: 1516px; min-height: 796px;">
                ...
                <article>
                    <h2 class="text-center transform titreArticle">Gallerie photo 1</h2>
                    <div class="article row lato  ">
                        <div class="text-center transform thumb"></div>
                        <div>
                            <style type="text/css">
                            ...
                            <div id="gallery-1" class="gallery galleryid-35 gallery-columns-3 gallery-size-thumbnail"><dl class="gallery-item">
                                <dt class="gallery-icon landscape">
                                    <a href="{{ URL::asset('img/11.jpg') }}" data-slb-group="35" data-slb-active="1" data-slb-internal="0"><img width="150" height="150" src="{{ URL::asset('img/11-150x150.jpg') }}" class="attachment-thumbnail" alt="1"></a>
                                </dt></dl><dl class="gallery-item">
                                <dt class="gallery-icon landscape">
                                    <a href="{{ URL::asset('img/1.jpg') }}" data-slb-group="35" data-slb-active="1" data-slb-internal="0"><img width="150" height="150" src="{{ URL::asset('img/1-150x150.jpg') }}" class="attachment-thumbnail" alt="Hundetraining"></a>
                                </dt></dl><dl class="gallery-item">
                                <dt class="gallery-icon landscape">
                                    <a href="http://patrogem.be/cdrobermont-wp/wp-content/uploads/2015/05/Koala.jpg" data-slb-group="35" data-slb-active="1" data-slb-internal="0"><img width="150" height="150" src="{{ URL::asset('img/Koala-150x150.jpg') }}" class="attachment-thumbnail" alt="Koala"></a>
